...
public class CollectionsHolder {
    private final List<Site> siteList = Collections.synchronizedList(new ArrayList<>());
    ...
    private final List<Lemma> lemmaList = Collections.synchronizedList(new ArrayList<>());
}
